...
# # End of template
# ----------------------------------------
# If pixel_pll is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 189 win32 2016.02.12.19:38:24
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pixel_pll.vho"
}
